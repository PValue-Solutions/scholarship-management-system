        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('Edit Teacher')</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>@lang('Edit Teacher')</h3>
            </div>
            <div class="card-body">
                <form class="form-material form-horizontal" action="{{ route('scholarship-teacher.update', $scholarshipTeacher) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control ambitious-form-loading @error('name') is-invalid @enderror" name="name" value="{{ old('name', $scholarshipTeacher->name) }}" id="name" type="text" placeholder="{{ __('Type Teacher Name Here') }}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control ambitious-form-loading @error('email') is-invalid @enderror" name="email" value="{{ old('email', $scholarshipTeacher->email) }}" id="email" type="email" placeholder="@lang('Type Email Here')">
                                @error('email')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="scholarship_school_id" id="scholarship_school_id">
                                    ...
                                    @foreach ($schools as $key => $value)
                                        <option value="{{ $key }}" @if(old('scholarship_school_id', $scholarshipTeacher->scholarship_school_id) == $key) selected @endif>{{ $value }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="scholarship_college_id" id="scholarship_college_id">
                                    ...
                                    @foreach ($colleges as $key => $value)
                                        <option value="{{ $key }}" @if(old('scholarship_college_id', $scholarshipTeacher->scholarship_college_id) == $key) selected @endif>{{ $value }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="phone" name="phone" value="{{ old('phone', $scholarshipTeacher->phone) }}" class="form-control @error('phone') is-invalid @enderror" placeholder="@lang('Phone')">
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" name="date_of_birth" id="date_of_birth" class="form-control flatpickr @error('date_of_birth') is-invalid @enderror" placeholder="@lang('Date of Birth')" value="{{ old('date_of_birth', $scholarshipTeacher->date_of_birth) }}">
                                    @error('date_of_birth')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="gender" class="form-control @error('gender') is-invalid @enderror" id="gender">
                                        ...
                                        <option value="male" @if(old('gender', $scholarshipTeacher->gender) == 'male') selected @endif>@lang('Male')</option>
                                        <option value="female" @if(old('gender', $scholarshipTeacher->gender) == 'female') selected @endif>@lang('Female')</option>
                                    </select>
                                    @error('gender')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="hidden" name="address" value="{{ old('address', $scholarshipTeacher->address) }}" id="address">
                                @error('address')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control ambitious-form-loading @error('status') is-invalid @enderror" required="required" name="status" id="status">
                                    <option value="1" @if(old('status', $scholarshipTeacher->status) == '1') selected @endif>@lang('Active')</option>
                                    <option value="0" @if(old('status', $scholarshipTeacher->status) == '0') selected @endif>@lang('Inactive')</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">
                                        {{ $message }}
