        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">{{ __('Create College') }}</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3>{{ __('New College') }}</h3>
            </div>
            <div class="card-body">
                <form id="itemQuickForm" class="form-material form-horizontal" action="{{ route('scholarship-college.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control ambitious-form-loading @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" id="name" type="text" placeholder="{{ __('Type Your College Name Here') }}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control ambitious-form-loading @error('college_type') is-invalid @enderror" required="required" name="college_type" id="college_type">
                                    <option value="">@lang('Select College Type')</option>
                                    <option value="Govt." {{ old('college_type') === 'Govt.' ? 'selected' : '' }}>@lang('Govt.')</option>
                                    <option value="Govt. Aided" {{ old('college_type') === 'Govt. Aided' ? 'selected' : '' }}>@lang('Govt. Aided')</option>
                                    <option value="Private" {{ old('college_type') === 'Private' ? 'selected' : '' }}>@lang('Private')</option>
                                </select>
                                @error('college_type')
                                    <div class="invalid-feedback">
                                        {{ $message }}
