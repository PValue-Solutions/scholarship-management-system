        ...
        <div class="col-12">
            <div class="material-card card">
                ...
                <div class="card-body wizard-content">
                    <form enctype="multipart/form-data" action="#" id="scholarship_edit_form"
                        class="validation-wizard wizard-circle mt-5" method="post">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="application_no"
                                            class="form-control @if ($errors->has('application_no')) is-invalid @endif"
                                            name="application_no" type="text"
                                            value="{{ old('application_no', $scholarship->application_no) }}" required
                                            readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="year" class="form-control" name="year" type="text" value="{{ old('year', $scholarship->year) }}" required readonly>
                                    @if ($errors->has('year'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="year" id="year" required>
                                            ...
                                            @foreach ($years as $key => $value)
                                                <option value="{{ $value }}"
                                                    {{ old('year', $scholarship->year) == $value ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('year')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="annual_income"
                                            class="form-control @if ($errors->has('annual_income')) is-invalid @endif"
                                            name="annual_income" type="number"
                                            value="{{ old('annual_income', $scholarship->annual_income) }}"
                                            placeholder="Annual Income of Your Guardian" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="percentage_marks_obtained">
                                            {{ __('Percentage of Last Examination Marks') }} <b
                                                class="ambitious-crimson">*</b>
                                        </label>
                                        <input id="percentage_marks_obtained"
                                            class="form-control @if ($errors->has('percentage_marks_obtained')) is-invalid @endif"
                                            name="percentage_marks_obtained" type="number"
                                            value="{{ old('percentage_marks_obtained', $scholarship->percentage_marks_obtained) }}"
                                            placeholder="Percentage Marks In Your Last Examination" required readonly>
                        ...
                        <section>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input id="full_name"
                                            ...
                                            value="{{ old('full_name', $scholarship->studentDetail->full_name) }}"
                                            placeholder="Type Your Full Name" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="father_name"
                                            ...
                                            value="{{ old('father_name', $scholarship->studentDetail->father_name) }}"
                                            placeholder="Type Your Father Name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="father_occupation"
                                            class="form-control @if ($errors->has('father_occupation')) is-invalid @endif"
                                            name="father_occupation" type="text"
                                            value="{{ old('father_occupation', $scholarship->studentDetail->father_occupation) }}"
                                            placeholder="Type Your Father Occupation" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="mother_name"
                                            class="form-control @if ($errors->has('mother_name')) is-invalid @endif"
                                            name="mother_name" type="text"
                                            value="{{ old('mother_name', $scholarship->studentDetail->mother_name) }}"
                                            placeholder="Type Your Mother Name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="mother_occupation"
                                            class="form-control @if ($errors->has('mother_occupation')) is-invalid @endif"
                                            name="mother_occupation" type="text"
                                            value="{{ old('mother_occupation', $scholarship->studentDetail->mother_occupation) }}"
                                            placeholder="Type Your Mother Occupation" required>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="house_no"
                                            class="form-control @if ($errors->has('house_no')) is-invalid @endif"
                                            name="house_no" type="text"
                                            value="{{ old('house_no', $scholarship->studentDetail->house_no) }}"
                                            placeholder="Type Your House No" required readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="scholarship_village_id"
                                            id="scholarship_village_id" required>
                                            <option value="">Select Village</option>
                                            @foreach ($villages as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old('scholarship_village_id', $scholarship->studentDetail->scholarship_village_id) == $key) selected @else disabled @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="street"
                                            ...
                                            value="{{ old('street', $scholarship->studentDetail->street) }}"
                                            placeholder="Type Your Street" required readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="post_office"
                                            class="form-control @if ($errors->has('post_office')) is-invalid @endif"
                                            name="post_office" type="text"
                                            value="{{ old('post_office', $scholarship->studentDetail->post_office) }}"
                                            placeholder="Type Your Post Office" required readonly>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="taluk"
                                            class="form-control @if ($errors->has('taluk')) is-invalid @endif"
                                            name="taluk" type="text"
                                            value="{{ old('taluk', $scholarship->studentDetail->taluk) }}"
                                            placeholder="Type Your Taluk" required readonly>
                                        @if ($errors->has('taluk'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="district"
                                            ...
                                            value="{{ old('district', $scholarship->studentDetail->district) }}"
                                            placeholder="Type Your District" required readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="pincode"
                                            class="form-control @if ($errors->has('pincode')) is-invalid @endif"
                                            name="pincode" type="number"
                                            value="{{ old('pincode', $scholarship->studentDetail->pincode) }}"
                                            placeholder="Type Your Pincode" required readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="state"
                                            ...
                                            value="{{ old('state', $scholarship->studentDetail->state) }}"
                                            placeholder="Type Your State" required readonly>
                                        @if ($errors->has('state'))
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date_of_birth">@lang('Date of Birth') <b
                                                class="ambitious-crimson">*</b></label>
                                        <input type="text" name="date_of_birth"
                                            value="{{ $scholarship->studentDetail->date_of_birth }}" id="date_of_birth"
                                            class="form-control flatpickr @error('date_of_birth') is-invalid @enderror"
                                            placeholder="@lang('Date of Birth')" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="contact_no_1"
                                            class="form-control @if ($errors->has('contact_no_1')) is-invalid @endif"
                                            name="contact_no_1" type="number"
                                            value="{{ old('contact_no_1', $scholarship->studentDetail->contact_no_1) }}"
                                            placeholder="Type Your Contact No 1" required readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="contact_no_2"
                                            class="form-control @if ($errors->has('contact_no_2')) is-invalid @endif"
                                            name="contact_no_2" type="number"
                                            value="{{ old('contact_no_2', $scholarship->studentDetail->contact_no_2) }}"
                                            placeholder="Type Your Contact No 2" required readonly>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" class="form-control @error('gender') is-invalid @enderror"
                                            ...
                                            <option value="male"
                                                {{ old('gender', $scholarship->studentDetail->gender) === 'male' ? 'selected' : 'disabled' }}>
                                                @lang('Male')</option>
                                            <option value="female"
                                                {{ old('gender', $scholarship->studentDetail->gender) === 'female' ? 'selected' : 'disabled' }}>
                                                @lang('Female')</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="age"
                                            ...
                                            value="{{ old('age', $scholarship->studentDetail->age) }}"
                                            placeholder="Type Your Age" required>
                                        @if ($errors->has('age'))
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="aadhar_no"
                                            class="form-control @if ($errors->has('aadhar_no')) is-invalid @endif"
                                            name="aadhar_no" type="number"
                                            value="{{ old('aadhar_no', $scholarship->studentDetail->aadhar_no) }}"
                                            placeholder="Type Aadhar No" required>
                        ...
                        <section>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="school_or_college">@lang('Institution') <b
                                                class="ambitious-crimson">*</b></label>
                                        <select
                                            class="form-control ambitious-form-loading @error('school_or_college') is-invalid @enderror"
                                            required="required" name="school_or_college" id="school_or_college">
                                            <option value="1"
                                                @if (old('school_or_college', $scholarship->school_or_college) == '1') selected @else disabled @endif>
                                                @lang('School')</option>
                                            <option value="2"
                                                @if (old('school_or_college', $scholarship->school_or_college) == '2') selected @else disabled @endif>
                                                @lang('College')</option>
                                        </select>
                                ...
                                <div id="school_block" class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="scholarship_school_id"
                                            id="scholarship_school_id">
                                            <option value="">Select School</option>
                                            @foreach ($schools as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old('scholarship_school_id', $scholarship->scholarship_school_id) == $key) selected @else disabled @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div id="college_block" class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="scholarship_college_id"
                                            id="scholarship_college_id">
                                            <option value="">Select College</option>
                                            @foreach ($colleges as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old('scholarship_college_id', $scholarship->scholarship_college_id) == $key) selected @else disabled @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="school_year" id="school_year">
                                            ...
                                            @foreach ($years as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old('school_year', $scholarship->school_year) == $key) selected @endif>{{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('school_year')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="course"
                                            value="{{ $scholarship->course }}" required>
                                        @error('course')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="school_grade" id="school_grade">
                                            ...
                                            @foreach ($classes as $key => $value)
                                                ...
                                                <option value="{{ $key }}"
                                                    @if (old('school_grade', $scholarship->school_grade) == $key) selected @else disabled @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('school_grade')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="combination"
                                            value="{{ $scholarship->combination }}" required>
                                        @error('combination')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="total_marks"
                                            value="{{ $scholarship->total_marks }}" required>
                                        @error('total_marks')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="obtained_marks"
                                            value="{{ $scholarship->obtained_marks }}" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="percentage"
                                            value="{{ $scholarship->percentage }}" required>
                                        @error('percentage')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="1" @if (old('further_education_details_school_or_college', $scholarship->further_education_details_school_or_college) ==
                                                    '1') selected @endif>
                                                @lang('School')</option>
                                            <option value="2" @if (old('further_education_details_school_or_college', $scholarship->further_education_details_school_or_college) ==
                                                    '2') selected @endif>
                                                @lang('College')</option>
                                        </select>
                                            ...
                                            @foreach ($schools as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old(
                                                            ...
                                                            $scholarship->further_education_details_scholarship_school_id) == $key) selected @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                            ...
                                            @foreach ($colleges as $key => $value)
                                                <option value="{{ $key }}"
                                                    @if (old(
                                                            ...
                                                            $scholarship->further_education_details_scholarship_college_id) == $key) selected @endif>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="further_education_details_course_joined"
                                            ...
                                            value="{{ old('further_education_details_course_joined', $scholarship->further_education_details_course_joined) }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="marks_obtained_type">@lang('Examination Type') <b
                                                class="ambitious-crimson">*</b></label>
                                        <select name="marks_obtained_type"
                                            class="form-control @error('marks_obtained_type') is-invalid @enderror"
                                            id="marks_obtained_type" required>
                                            <option value="">--@lang('Select')--</option>
                                            <option value="SSLC"
                                                {{ old('marks_obtained_type', $scholarship->marks_obtained_type) === 'SSLC' ? 'selected' : '' }}>
                                                @lang('SSLC')</option>
                                            <option value="PUC"
                                                {{ old('marks_obtained_type', $scholarship->marks_obtained_type) === 'PUC' ? 'selected' : '' }}>
                                                @lang('PUC')</option>
                                            <option value="Degree"
                                                {{ old('marks_obtained_type', $scholarship->marks_obtained_type) === 'Degree' ? 'selected' : '' }}>
                                                @lang('Degree')</option>
                                        </select>
                                ...
                                <div id="examination_subject_block" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="marks_subject"
                                            class="form-control @if ($errors->has('marks_subject')) is-invalid @endif"
                                            name="marks_subject" type="text"
                                            value="{{ old('marks_subject', $scholarship->marks_subject) }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="marks_obtained"
                                            ...
                                            name="marks_obtained" type="text"
                                            value="{{ old('marks_obtained', $scholarship->marks_obtained) }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline ">
                                            <input class="form-check-input" type="radio" name="previously_scholarship"
                                                ...
                                                {{ $scholarship->previously_scholarship == 'Yes' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="inlineRadio1">&nbsp; Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="previously_scholarship"
                                                id="inlineRadio2" value="No"
                                                {{ $scholarship->previously_scholarship == 'No' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline ">
                                            <input class="form-control" type="text" name="how_many_years"
                                                value="{{ $scholarship->how_many_years }}">
                                        </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="school_contact_person"
                                            class="form-control @if ($errors->has('school_contact_person')) is-invalid @endif"
                                            name="school_contact_person" type="text"
                                            value="{{ old('school_contact_person', $scholarship->school_contact_person) }}"
                                            placeholder="Type Your Contact Person" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="school_designation"
                                            class="form-control @error('school_designation') is-invalid @enderror"
                                            id="school_designation" required>
                                            <option value="">--@lang('Select')--</option>
                                            <option value="Principal"
                                                {{ old('school_designation', $scholarship->school_designation) === 'Principal' ? 'selected' : '' }}>
                                                @lang('Principal')</option>
                                            <option value="Head"
                                                {{ old('school_designation', $scholarship->school_designation) === 'Head' ? 'selected' : '' }}>
                                                @lang('Head')</option>
                                            <option value="Teacher"
                                                {{ old('school_designation', $scholarship->school_designation) === 'Teacher' ? 'selected' : '' }}>
                                                @lang('Teacher')</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="school_contact_number"
                                            class="form-control @if ($errors->has('school_contact_number')) is-invalid @endif"
                                            name="school_contact_number" type="number"
                                            value="{{ old('school_contact_number', $scholarship->school_contact_number) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="bank_name"
                                            ...
                                            value="{{ old('bank_name', $scholarship->scholarshipBankDetail->bank_name) }}"
                                            placeholder="Type Your Bank Name" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="branch"
                                            ...
                                            value="{{ old('branch', $scholarship->scholarshipBankDetail->branch) }}"
                                            placeholder="Type Your Branch" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="account_holder_name"
                                            class="form-control @if ($errors->has('account_holder_name')) is-invalid @endif"
                                            name="account_holder_name" type="text"
                                            value="{{ old('account_holder_name', $scholarship->scholarshipBankDetail->account_holder_name) }}"
                                            placeholder="Type Your Account Holder Name" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="account_no"
                                            ...
                                            value="{{ old('account_no', $scholarship->scholarshipBankDetail->account_no) }}"
                                            placeholder="Type Your Account No" required readonly>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="ifsc_code"
                                            class="form-control @if ($errors->has('ifsc_code')) is-invalid @endif"
                                            name="ifsc_code" type="text"
                                            value="{{ old('ifsc_code', $scholarship->scholarshipBankDetail->ifsc_code) }}"
                                            placeholder="Type Your IFSC Code" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control @error('status') is-invalid @enderror"
                                            ...
                                            <option value="">--@lang('Select')--</option>
                                            <option value="Self"
                                                {{ old('status', $scholarship->scholarshipBankDetail->status) === 'Self' ? 'selected' : 'disabled' }}>
                                                @lang('Self')</option>
                                            <option value="Father"
                                                {{ old('status', $scholarship->scholarshipBankDetail->status) === 'Father' ? 'selected' : 'disabled' }}>
                                                @lang('Father')</option>
                                            <option value="Mother"
                                                {{ old('status', $scholarship->scholarshipBankDetail->status) === 'Mother' ? 'selected' : 'disabled' }}>
                                                @lang('Mother')</option>
                                            <option value="Teacher"
                                                {{ old('status', $scholarship->scholarshipBankDetail->status) === 'Teacher' ? 'selected' : 'disabled' }}>
                                                @lang('Teacher')</option>
                                        </select>
                        ...
                        <section>
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="photo" class="dropify" name="photo"
                                            value="{{ old('photo') }}" type="file"
                                            data-allowed-file-extensions="png jpg jpeg" data-max-file-size="5500K" />
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="income_certificate">
                                            {{ __('Income certificate of Parents/ Guardian') }} <b
                                                class="ambitious-crimson">*</b>
                                        </label>
                                        <input id="income_certificate" class="dropify" name="income_certificate"
                                            value="{{ old('income_certificate') }}" type="file"
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" />
                                        <small class="form-text text-muted">@lang('Leave Blank For Remain Unchanged')</small>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="id_proof">
                                            {{ __('Govt. ID proof (Aadhar, Ration card etc.)') }} <b
                                                class="ambitious-crimson">*</b>
                                        </label>
                                        <input id="id_proof" class="dropify" name="id_proof"
                                            value="{{ old('id_proof') }}" type="file"
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" />
                                        <small class="form-text text-muted">@lang('Leave Blank For Remain Unchanged')</small>
                                        <p>@lang('Max Size: 5mb, Allowed Format: pdf')</p>
                                    </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="previous_educational_marks_card">
                                            {{ __('Previous Educational Marks Card') }} <b
                                                class="ambitious-crimson">*</b>
                                        </label>
                                        <input id="previous_educational_marks_card" class="dropify"
                                            name="previous_educational_marks_card"
                                            value="{{ old('previous_educational_marks_card') }}" type="file"
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" />
                                        <small class="form-text text-muted">@lang('Leave Blank For Remain Unchanged')</small>
                                        <p>@lang('Max Size: 5mb, Allowed Format: pdf')</p>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="bank_passbook" class="dropify" name="bank_passbook"
                                            value="{{ old('bank_passbook') }}" type="file"
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" />
                                        <small class="form-text text-muted">@lang('Leave Blank For Remain Unchanged')</small>
                                        <p>@lang('Max Size: 5mb, Allowed Format: pdf')</p>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="original_fee_receipt" class="dropify" name="original_fee_receipt"
                                            value="{{ old('original_fee_receipt') }}" type="file"
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" />
                                        <small class="form-text text-muted">@lang('Leave Blank For Remain Unchanged')</small>
                                        <p>@lang('Max Size: 5mb, Allowed Format: pdf')</p>
                                    </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"type="number"
                                            value="{{ $scholarship->apply_amount }}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="fee_amount"
                                            class="form-control @if ($errors->has('fee_amount')) is-invalid @endif"
                                            name="fee_amount" type="number" value="{{ $eAmount }}"
                                            placeholder="Type Eligibility Amount" required readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date">@lang('Date') <b
                                                class="ambitious-crimson">*</b></label>
                                        <input type="text" name="date" id="date"
                                            class="form-control flatpickr @error('date') is-invalid @enderror"
                                            placeholder="@lang('Date')" value="{{ $scholarship->date }}" required>
                                        @if ($errors->has('date'))
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="role-form-ambi checkbox checkbox-primary">
                                            <input name="given_information" id="given_information" type="checkbox"
                                                value="1" checked>
                                            <label for="given_information">
                                                I certified that the information given in above is true and correct. <b
                                                    class="ambitious-crimson">*</b>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="role-form-ambi checkbox checkbox-primary">
                                            <input name="any_other_scholarship" id="any_other_scholarship"
                                                type="checkbox" value="1" checked>
                                            <label for="any_other_scholarship">
                                                I am not availing any other scholarship for this purpose from any
                                                NGO/State/Central Govt. <b class="ambitious-crimson">*</b>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="role-form-ambi checkbox checkbox-primary">
                                            <input name="scholarship_refunded" id="scholarship_refunded" type="checkbox"
                                                value="1" checked>
                                            <label for="scholarship_refunded">
                                                If the information given by me is found to be false/incorrect, the
                                                scholarship sanction to me may be cancelled <br>
                                                and the amount of scholarship refunded by me. <b
                                                    class="ambitious-crimson">*</b>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            @if ($roleName['0'] != 'Student')
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="s_status">@lang('Status') <b
                                                    class="ambitious-crimson">*</b></label>
                                            <select name="s_status"
                                                class="form-control @error('s_status') is-invalid @enderror"
                                                id="s_status">
                                                <option value="">--@lang('Select')--</option>
                                                <option value="pending"
                                                    {{ old('s_status', $scholarship->status) === 'pending' ? 'selected' : '' }}>
                                                    @lang('Under Verification')</option>
                                                <option value="approved"
                                                    {{ old('s_status', $scholarship->status) === 'approved' ? 'selected' : '' }}>
                                                    @lang('Approved')</option>
                                                <option value="payment_in_progress"
                                                    {{ old('s_status', $scholarship->status) === 'payment_in_progress' ? 'selected' : '' }}>
                                                    @lang('Payment In Progress')</option>
                                                <option value="payment_done"
                                                    {{ old('s_status', $scholarship->status) === 'payment_done' ? 'selected' : '' }}>
                                                    @lang('Payment Done')</option>
                                                <option value="rejected"
                                                    {{ old('s_status', $scholarship->status) === 'rejected' ? 'selected' : '' }}>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#s_status').change(function() {
                if ($('#s_status').val() == 'payment_in_progress' || $('#s_status').val() ==
                    'payment_done') {
                    $('#payment_date_block').show();
                } else {
                    $('#payment_date_block').hide();
        ...
        $(document).ready(function() {
            ...
            $('#marks_obtained_type').change(function() {
                if ($('#marks_obtained_type').val() == 'PUC' || $('#marks_obtained_type').val() ==
                    'Degree') {
                    $('#examination_subject_block').show();
                } else {
                    $('#examination_subject_block').hide();
            ...
            var further_education_details_school_or_college = $('#further_education_details_school_or_college')
                .val();
        ...
        $(".validation-wizard").steps({
            ...
            onStepChanging: function(event, currentIndex, newIndex) {
                ...
                if (currentIndex == 2) {
                    ...
                    var further_education_details_school_or_college = $(
                        '#further_education_details_school_or_college').val();
                    if (further_education_details_school_or_college == '1') {
                        var further_education_details_scholarship_school_id = $(
                            '#further_education_details_scholarship_school_id').val();
                        if (further_education_details_scholarship_school_id == "" ||
                            further_education_details_scholarship_school_id == undefined) {
                            Swal.fire(
                                itemName,
                        ...
                        var further_education_details_scholarship_college_id = $(
                            '#further_education_details_scholarship_college_id').val();
                        if (further_education_details_scholarship_college_id == "" ||
                            further_education_details_scholarship_college_id == undefined) {
                            Swal.fire(
                                itemName,
