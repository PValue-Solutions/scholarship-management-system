                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="application_no" class="form-control @if($errors->has('application_no')) is-invalid @endif" name="application_no" type="text" value="{{ old('application_no', $scholarship->application_no) }}" required readonly>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="father_name" class="form-control @if($errors->has('father_name')) is-invalid @endif" name="father_name" type="text" value="{{ old('father_name',$scholarship->studentDetail->father_name) }}" placeholder="Type Your Father Name" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="father_occupation" class="form-control @if($errors->has('father_occupation')) is-invalid @endif" name="father_occupation" type="text" value="{{ old('father_occupation',$scholarship->studentDetail->father_occupation) }}" placeholder="Type Your Father Occupation" required>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="mother_name" class="form-control @if($errors->has('mother_name')) is-invalid @endif" name="mother_name" type="text" value="{{ old('mother_name',$scholarship->studentDetail->mother_name) }}" placeholder="Type Your Mother Name" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="mother_occupation" class="form-control @if($errors->has('mother_occupation')) is-invalid @endif" name="mother_occupation" type="text" value="{{ old('mother_occupation',$scholarship->studentDetail->mother_occupation) }}" placeholder="Type Your Mother Occupation" required>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date_of_birth" value="{{ $scholarship->studentDetail->date_of_birth }}" id="date_of_birth" class="form-control flatpickr @error('date_of_birth') is-invalid @enderror" placeholder="@lang('Date of Birth')" required>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="age" class="form-control @if($errors->has('age')) is-invalid @endif" name="age" type="number" value="{{ old('age',$scholarship->studentDetail->age) }}" placeholder="Type Your Age" required>
                                    @if ($errors->has('age'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="school_year" id="school_year">
                                        ...
                                        @foreach ($years as $key => $value)
                                            <option value="{{ $key }}" @if(old('school_year', $scholarship->school_year) == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                    @error('school_year')
                                        <div class="invalid-feedback">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="school_contact_person" class="form-control @if($errors->has('school_contact_person')) is-invalid @endif" name="school_contact_person" type="text" value="{{ old('school_contact_person',$scholarship->school_contact_person) }}" placeholder="Type Your Contact Person" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="school_designation" class="form-control @error('school_designation') is-invalid @enderror" id="school_designation" required>
                                        <option value="">--@lang('Select')--</option>
                                        <option value="Principal" {{ old('school_designation',$scholarship->school_designation) === 'Principal' ? 'selected' : '' }}>@lang('Principal')</option>
                                        <option value="Head" {{ old('school_designation',$scholarship->school_designation) === 'Head' ? 'selected' : '' }}>@lang('Head')</option>
                                        <option value="Teacher" {{ old('school_designation',$scholarship->school_designation) === 'Teacher' ? 'selected' : '' }}>@lang('Teacher')</option>
                                    </select>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="marks_obtained_type" class="form-control @error('marks_obtained_type') is-invalid @enderror" id="marks_obtained_type" required>
                                        <option value="">--@lang('Select')--</option>
                                        <option value="SSLC" {{ old('marks_obtained_type',$scholarship->marks_obtained_type) === 'SSLC' ? 'selected' : '' }}>@lang('SSLC')</option>
                                        <option value="PUC" {{ old('marks_obtained_type',$scholarship->marks_obtained_type) === 'PUC' ? 'selected' : '' }}>@lang('PUC')</option>
                                        <option value="Degree" {{ old('marks_obtained_type',$scholarship->marks_obtained_type) === 'Degree' ? 'selected' : '' }}>@lang('Degree')</option>
                                    </select>
                            ...
                            <div id="examination_subject_block" class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="marks_subject" class="form-control @if($errors->has('marks_subject')) is-invalid @endif" name="marks_subject" type="text" value="{{ old('marks_subject',$scholarship->marks_subject) }}" placeholder="Type Your subject">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="marks_obtained" class="form-control @if($errors->has('marks_obtained')) is-invalid @endif" name="marks_obtained" type="text" value="{{ old('marks_obtained',$scholarship->marks_obtained) }}" placeholder="Type Your Marks" required>
                                    @if ($errors->has('marks_obtained'))
                                        {{ Session::flash('error',$errors->first('marks_obtained')) }}
                                    @endif
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control ambitious-form-loading @error('further_education_details_school_or_college') is-invalid @enderror" required="required" name="further_education_details_school_or_college" id="further_education_details_school_or_college">
                                        <option value="1" @if(old('further_education_details_school_or_college', $scholarship->further_education_details_school_or_college) == '1') selected @endif>@lang('School')</option>
                                        <option value="2" @if(old('further_education_details_school_or_college', $scholarship->further_education_details_school_or_college) == '2') selected @endif>@lang('College')</option>
                                    </select>
                            ...
                            <div id="further_education_details_school_block" class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="further_education_details_scholarship_school_id" id="further_education_details_scholarship_school_id">
                                        <option value="">Select School</option>
                                        @foreach ($schools as $key => $value)
                                            <option value="{{ $key }}" @if(old('further_education_details_scholarship_school_id', $scholarship->further_education_details_scholarship_school_id) == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div id="further_education_details_college_block" class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="further_education_details_scholarship_college_id" id="further_education_details_scholarship_college_id">
                                        <option value="">Select College</option>
                                        @foreach ($colleges as $key => $value)
                                            <option value="{{ $key }}" @if(old('further_education_details_scholarship_college_id', $scholarship->further_education_details_scholarship_college_id) == $key) selected @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                    ...
                    <section>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="fee_amount" class="form-control @if($errors->has('fee_amount')) is-invalid @endif" name="fee_amount" type="number" value="{{ $eAmount }}" placeholder="Type Eligibility Amount" required readonly>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="role-form-ambi checkbox checkbox-primary">
                                        <input name="given_information" id="given_information" type="checkbox" value="1" checked>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="role-form-ambi checkbox checkbox-primary">
                                        <input name="any_other_scholarship" id="any_other_scholarship" type="checkbox" value="1" checked>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="role-form-ambi checkbox checkbox-primary">
                                        <input name="scholarship_refunded" id="scholarship_refunded" type="checkbox" value="1" checked>
