        ...
        <div class="col-12">
            <div class="material-card card">
                ...
                <div class="card-body wizard-content">
                    <form enctype="multipart/form-data" action="#" id="scholarship_create_form"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="application_no"
                                            ...
                                            value="{{ old('application_no', $number) }}" required readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="annual_income"
                                            ...
                                            name="annual_income" type="number" value="{{ old('annual_income') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="percentage_marks_obtained"
                                            ...
                                            value="{{ old('percentage_marks_obtained') }}"
                                            placeholder="Percentage Marks In Your Last Examination" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="full_name"
                                                ...
                                                name="full_name" type="text" value="{{ old('full_name') }}"
                                ...
                                @else
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select style="width: 100%" class="form-control select2" name="full_name"
                                                id="full_name" required>
                                                <option value="">Select Student</option>
                                                @foreach ($students as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ old('full_name') == $key ? 'selected' : '' }}>
                                                        {{ $value }}</option>
                                                @endforeach
                                            </select>
                                            @if ($errors->has('full_name'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="father_name"
                                            ...
                                            name="father_name" type="text" value="{{ old('father_name') }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="house_no"
                                            ...
                                            name="house_no" type="text" value="{{ old('house_no') }}"
                                            placeholder="Type Your House No" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="scholarship_village_id"
                                            id="scholarship_village_id" required>
                                            <option value="">Select Village</option>
                                            @foreach ($villages as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('scholarship_village_id') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="street"
                                            ...
                                            name="street" type="text" value="{{ old('street') }}"
                                            placeholder="Type Your Street" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="post_office"
                                            ...
                                            placeholder="Type Your Post Office" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="taluk"
                                            ...
                                            name="taluk" type="text" value="{{ old('taluk') }}"
                                            placeholder="Type Your Taluk" required>
                                        @if ($errors->has('taluk'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="district"
                                            ...
                                            name="district" type="text" value="{{ old('district') }}"
                                            placeholder="Type Your District" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="pincode"
                                            ...
                                            name="pincode" type="number" value="{{ old('pincode') }}"
                                            placeholder="Type Your Pincode" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input id="state"
                                            ...
                                            placeholder="Type Your State" required>
                                        @if ($errors->has('state'))
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="contact_no_1"
                                            ...
                                            name="contact_no_1" type="number" value="{{ old('contact_no_1') }}"
                                            placeholder="Type Your Contact No 1" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="contact_no_2"
                                            ...
                                            name="contact_no_2" type="number" value="{{ old('contact_no_2') }}"
                                            placeholder="Type Your Contact No 2" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="age"
                                            ...
                                            name="age" type="number" value="{{ old('age') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="aadhar_no"
                                            ...
                                            name="aadhar_no" type="number" value="{{ old('aadhar_no') }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select
                                            ...
                                            <option value="1" {{ old('school_or_college') === 1 ? 'selected' : '' }}>
                                                @lang('School')</option>
                                            <option value="2" {{ old('school_or_college') === 2 ? 'selected' : '' }}>
                                                @lang('College')</option>
                                        </select>
                                ...
                                <div id="school_block" class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="scholarship_school_id"
                                            id="scholarship_school_id">
                                            <option value="">Select School</option>
                                            @foreach ($schools as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('scholarship_school_id') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div id="college_block" class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="scholarship_college_id"
                                            id="scholarship_college_id">
                                            <option value="">Select College</option>
                                            @foreach ($colleges as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ old('scholarship_college_id') == $key ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="marks_obtained_type"
                                            ...
                                            <option value="">--@lang('Select')--</option>
                                            <option value="SSLC"
                                                {{ old('marks_obtained_type') === 'SSLC' ? 'selected' : '' }}>
                                                @lang('SSLC')</option>
                                            <option value="PUC"
                                                {{ old('marks_obtained_type') === 'PUC' ? 'selected' : '' }}>
                                                @lang('PUC')</option>
                                            <option value="Degree"
                                                {{ old('marks_obtained_type') === 'Degree' ? 'selected' : '' }}>
                                                @lang('Degree')</option>
                                        </select>
                                ...
                                <div id="examination_subject_block" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="marks_subject"
                                            ...
                                            name="marks_subject" type="text" value="{{ old('marks_subject') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="school_designation"
                                            ...
                                            <option value="Principal"
                                                {{ old('school_designation') === 'Principal' ? 'selected' : '' }}>
                                                @lang('Principal')</option>
                                            <option value="Head"
                                                {{ old('school_designation') === 'Head' ? 'selected' : '' }}>
                                                @lang('Head')</option>
                                            <option value="Teacher"
                                                {{ old('school_designation') === 'Teacher' ? 'selected' : '' }}>
                                                @lang('Teacher')</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="school_contact_number"
                                            ...
                                            value="{{ old('school_contact_number') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="branch"
                                            ...
                                            name="branch" type="text" value="{{ old('branch') }}"
                                            placeholder="Type Your Branch" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="account_holder_name"
                                            ...
                                            placeholder="Type Your Account Holder Name" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="account_no"
                                            ...
                                            name="account_no" type="number" value="{{ old('account_no') }}"
                                            placeholder="Type Your Account No" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="ifsc_code"
                                            ...
                                            name="ifsc_code" type="text" value="{{ old('ifsc_code') }}"
                                            placeholder="Type Your IFSC Code" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control @error('status') is-invalid @enderror"
                                            id="status" required>
                                            <option value="">--@lang('Select')--</option>
                                            <option value="Self" {{ old('status') === 'Self' ? 'selected' : '' }}>
                                                @lang('Self')</option>
                                            <option value="Father" {{ old('status') === 'Father' ? 'selected' : '' }}>
                                                @lang('Father')</option>
                                            <option value="Mother" {{ old('status') === 'Mother' ? 'selected' : '' }}>
                                                @lang('Mother')</option>
                                            <option value="Teacher" {{ old('status') === 'Teacher' ? 'selected' : '' }}>
                                                @lang('Teacher')</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="income_certificate" class="dropify" name="income_certificate"
                                            ...
                                            data-allowed-file-extensions="pdf" data-max-file-size="5500K" required />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="fee_amount"
                                            ...
                                            name="fee_amount" type="number" value="{{ old('fee_amount') }}"
                                            placeholder="Type Fee Amount" required>
