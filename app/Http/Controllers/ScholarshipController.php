    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $scholarship = Scholarship::create([
                ...
                'photo' => $request->photo->store('public/scholarship'),
                'income_certificate' => $request->income_certificate->store('public/scholarship'),
                'id_proof' => $request->id_proof->store('public/scholarship'),
                'previous_educational_marks_card' => $request->previous_educational_marks_card->store('public/scholarship'),
                'bank_passbook' => $request->bank_passbook->store('public/scholarship'),
                'original_fee_receipt' => $request->original_fee_receipt->store('public/scholarship'),
            ]);
